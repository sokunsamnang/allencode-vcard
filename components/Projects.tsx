...
const Projects: React.FC<{}> = () => {
    const projects = [
        {
            ...
            title: "StadiumX",
            description:
                "Comprehensive sports management platform featuring ticketing systems, merchandise integration, and real-time analytics for professional sports organizations.",
            image: "/StadiumX.png",
            url: "https://stadiumx.asia",
        ...
        },
        {
            ...
            description:
                "Self-custody digital wallet supporting multi-chain assets and NFTs with enterprise-grade security and intuitive user experience.",
            image: "/BITRIEL.svg",
        ...
        {
            id: 3,
            title: "SALA MIL Cambodia",
            description:
                "The SALA MIL app provides lessons and tests that teach users about their digital responsibilities, how to protect their data and privacy, and how to avoid online scams or identity theft in the digital age.",
            image: "/Sala-Mil.png",
            url: "https://link.moeys.gov.kh/SALA_MIL",
            tags: [
                "SALA MIL",
                "MIL",
                "Education",
    ...
    return (
        <section
            id="projects"
            className="section-padding relative overflow-hidden bg-gray-950/50"
        >
            <div className="container mx-auto">
                <div className="max-w-4xl mx-auto text-center mb-16 animate-fade-in">
                    ...
                    <p className="text-gray-300 text-lg max-w-2xl mx-auto">
                        Real-world applications solving complex problems across
                        sports management and blockchain technology.
                    </p>
                </div>
